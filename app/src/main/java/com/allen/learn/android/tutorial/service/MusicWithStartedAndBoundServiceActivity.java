...
public class MusicWithStartedAndBoundServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music_started_bound);
        init();
    ...
    protected void onDestroy() {
        super.onDestroy();
        //退出应用后与service解除绑定
        musicControl.getService().stopSelf();
